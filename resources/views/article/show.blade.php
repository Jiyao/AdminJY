                ...
                <div class="row">
                    <div class="col-md-8">
                        <ul class="taglist taglist-inline header-block">
                            @foreach($article->tagged_name as $tagged_name)
                                <li class="tagpop">
                                    <a class="tag" href="{{ route('article.list.tag', ['tag'=>$tagged_name]) }}">{{ $tagged_name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <span class="header-info pull-right mr-top-8">
                            <a href="{{ route('article.list.category', ['category'=>$article->category_id]) }}">
                                <i class="fa fa-folder"></i>{{ $article->category_name }}
                            </a>
